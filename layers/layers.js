...
lyr_GoogleSatellite_0.setVisible(true);lyr_AP2025_aggiornamento5agosto_1.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_AP2025_aggiornamento5agosto_1];
...
lyr_AP2025_aggiornamento5agosto_1.set('fieldLabels', {'id': 'header label - always visible', 'NAME': 'inline label - always visible', 'DESCRIPTIO': 'inline label - always visible', 'MUN': 'inline label - always visible', 'name group': 'inline label - always visible', 'definizion': 'inline label - always visible', 'piu\' info': 'inline label - always visible', ' sup mq': 'inline label - always visible', });
